...
import pl.qwisdom.simpleradio.view.adapter.ViewPagerAdapter
...
import pl.qwisdom.simpleradio.view.view.fragment.RadioFragment
import pl.qwisdom.simpleradio.view.view.fragment.SettingsFragment
...
import pl.qwisdom.simpleradio.view.util.*
import pl.qwisdom.simpleradio.view.viewmodel.MainViewModel
import java.util.*
...
//        startActivity(intro)
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.country_check -> {
                countries.isClickable = when (country_check.isChecked) {
                    true -> true
                    else -> false
                }
            }
            R.id.type_check -> {
                types.isClickable = when (type_check.isChecked) {
                    true -> true
                    else -> false
                }
            }
